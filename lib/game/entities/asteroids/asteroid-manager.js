	...
	AsteroidManager = ig.Class.extend({
		...
		update: function()
		{
	    	...
	    	if(this.isRunning)
	    	{
	    		...
	    		if(this.asteroidsTotalCount >= this.asteroidsAllowed && this.asteroidsTotalCount !== 0){
	    			this.stopSpawn();
	    		}
	    		else{
	    	...
	    	if(this.asteroidsAlive === 0) this.hasStarted = false;
	    },
	    ...
	    killedAsteroid : function(asteroid)
	    {
	    	...
	    	for(var i = 0; i < numCoins; i++){
	    		ig.game.spawnEntity(CoinEntity, asteroid.pos.x, asteroid.pos.y);
	    	}
