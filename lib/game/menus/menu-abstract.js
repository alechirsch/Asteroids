...
.defines(function()
{
	...
	AbstractMenu= ig.Entity.extend({
	    ...
	    init: function(x, y, settings) 
	    {
	    	...
	    	this.createButton(.1,0,.8,70, "text", {text:"Start"});
	    	this.createButton(.1,100,.8,70, "text",{text:"Start"});
	    	this.createButton(.1,200,.8,70, "text", {text:"Start"});
	    	this.createButton(.1,300,.8,70, "text", {text:"Start"});
	    ...
	    createButton : function(x,y,w,h,type,settings)
	    {
	    	...
	    	this.menuItems.push(new TextMenuItem(x, y, w, h, settings.text));
	    },
